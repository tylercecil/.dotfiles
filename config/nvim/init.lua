...
require("lazy").setup({
		...
		config = function()
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					-- We pcreate a function that lets us more easily define mappings specific
					...
					map("gm", require("telescope.builtin").lsp_implementations, "[G]oto I[M]plementation")
	...
	{ -- You can easily change to a different colorscheme.
		...
		config = function(_, opts)
			...
			local colorFile = vim.fn.expand("~/.config/nvim/colors.lua")
	...
	-- This was a package for tree-sitter navagation, but... I'm not sure it's as nice as I was
	-- hoping.
	-- {
	-- 	"gsuuon/tshjkl.nvim",
	-- 	config = true,
